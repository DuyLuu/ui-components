 ...
 */
export type ColorKey = 'primary' | 'secondary' | 'background' | 'surface' | 'text' | 'light' | 'dark' | 'gray' | 'danger' | 'success' | 'warning';
export type SpacingKey = 'xs' | 's' | 'm' | 'l' | 'xl' | 'xxl';
export type TypographyVariant = 'h1' | 'h2' | 'h3' | 'h4' | 'body1' | 'body2' | 'caption' | 'button' | 'overline';
