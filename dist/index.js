...
var useBoxStyles = function useBoxStyles(props) {
  var theme = useTheme();
  return require$$0.useMemo(function () {
    var styles = {};
    // Layout props
...
var Box = function Box(_ref) {
  ...
  return jsxRuntimeExports.jsx(reactNative.View, _objectSpread2(_objectSpread2({
...
var Box$1 = /*#__PURE__*/require$$0.memo(Box);
...
var Text = function Text(_ref) {
  ...
  return jsxRuntimeExports.jsx(reactNative.Text, _objectSpread2(_objectSpread2({
...
var Text$1 = /*#__PURE__*/require$$0.memo(Text);
...
var Button = function Button(_ref) {
  ...
  var renderContent = function renderContent() {
    if (loading) {
      return jsxRuntimeExports.jsx(reactNative.ActivityIndicator, {
        size: "small",
  ...
  return jsxRuntimeExports.jsx(reactNative.TouchableOpacity, _objectSpread2(_objectSpread2({
...
var Button$1 = /*#__PURE__*/require$$0.memo(Button);
...
var Separator$1 = /*#__PURE__*/require$$0.memo(Separator);
...
var Image = function Image(_ref) {
  ...
  return jsxRuntimeExports.jsx(reactNative.Image, _objectSpread2({
    source: source,
    style: [imageStyles, style],
...
var Image$1 = /*#__PURE__*/require$$0.memo(Image);
...
var GradientView$1 = /*#__PURE__*/require$$0.memo(GradientView);
...
var useOptimizedStyle = function useOptimizedStyle(styleFactory, dependencies) {
  return require$$0.useMemo(styleFactory, dependencies);
};
var useOptimizedCallback = function useOptimizedCallback(callback, dependencies) {
  return require$$0.useCallback(callback, dependencies);
};
...
exports.GradientView = GradientView$1;
exports.Image = Image$1;
exports.Separator = Separator$1;
exports.Text = Text$1;
exports.createAccessibilityProps = createAccessibilityProps;
exports.createStyleSheet = createStyleSheet;
exports.disableAccessibility = disableAccessibility;
exports.getThemeValue = getThemeValue;
exports.isValidColorKey = isValidColorKey;
exports.isValidSpacingKey = isValidSpacingKey;
exports.mergeAccessibilityProps = mergeAccessibilityProps;
exports.mergeStyles = mergeStyles;
exports.responsive = responsive;
exports.useOptimizedCallback = useOptimizedCallback;
exports.useOptimizedStyle = useOptimizedStyle;
